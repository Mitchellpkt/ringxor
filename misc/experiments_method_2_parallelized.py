...
num_workers_basket_process: int = 1
...
logger.info(f"Loading data from: {input_data_path} with {num_workers_basket_process=}")
...
results_raw: List[Dict[str, Any]] = ringxor.process_bucket(
    relevant_rings, index_pairs=index_pairs, diagnostic_level=1, num_workers=num_workers_basket_process
)
